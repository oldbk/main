...
$stopc=0;
  while (($k_it > 0) and ($stopc!=600) )
	...
	$rx=mt_rand(15,$maxc-2); // разбрасываем квест поинты - не всамом начале лабы
	$ry=mt_rand(15,$maxc-2);
...
addchp ('<font color=red>Внимание!</font> Отличный Сувенир, пригодится...','{[]}'.$telo['login'].'{[]}',$telo['room'],$telo['id_city']);
