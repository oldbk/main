...
$mobs=2.8; //% монстров
$lov=1.5;  //% ловушек
$lov_yama=1.8;  //% ловушек простых ям
$lov_yama_fire=1.8;  //% ловушек огненных ям
$lov_yama_ice=1.8;  //% ловушек ледяных ям
$hils=2.3;  //% хилок
$ahils=2.3;  //% хилок
...
/////////////////////////////////// центр
 ...
 $rendu[$dim+1][$dim]='S'; $rendu[$dim+1][$dim+1]='х'; $rendu[$dim+1][$dim+2]='2'; //стрьевщик справа
