...
"279" => 40, // 200279 Совершенный свиток «Восстановление здоровья 180» 40
"277" => 135, // 200277 Средний свиток «Восстановление здоровья 720» 135
"280" => 135, // 200280 Большой свиток «Восстановление здоровья 720» 135
...
2277=>75, //Большой свиток «Восстановление 360HP»
...
310319=>5, // 319 Совершенный свиток «Восстановление 90 маны»
310320=> 25, // 320 Совершенный свиток «Восстановление 180 маны»
310321=> 50, // 321 Совершенный свиток «Восстановление здоровья 360»
310316=> 5, // 316 Большой свиток «Восстановление 90 маны»
310317=> 25, // 317 Большой свиток «Восстановление 180 маны»
310318=> 50, // 318 Большой свиток «Восстановление 360 маны»
310313=> 5, // 313 Средний свиток «Восстановление 90 маны»
310314=> 25, // 314 Средний свиток «Восстановление 180 маны»
310315=> 50, // 315 Средний свиток «Восстановление 360 маны»
310310=> 5, // 310 Малый свиток «Восстановление 90 маны»
310311=> 25, // 311 Малый свиток «Восстановление 180 маны»
310312=> 50, // 312 Малый свиток «Восстановление 360 маны» 

22222=>50, //все аптечки 1 юз 50 поинтов
...
if ($bat['coment'] =='<b>Куча-мала</b>') 
	...
	$KO_start_time30=mktime(0,0,0,5,29,date("Y"));  //2018-05-29 00:00:00
	$KO_fin_time30 =mktime(23,59,59,6,29,date("Y")); //2018-06-29 23:59:59

	$KO_start_time23=mktime(0,0,0,3,20,2017); // с 00:00 20/03 до 23:59 26/03
	$KO_fin_time23 =mktime(23,59,59,3,26,2017);

if (((time() >= $KO_start_time30) && (time() < $KO_fin_time30 )) OR ((time() >= $KO_start_time23) && (time() < $KO_fin_time23 )) )
	{
...
if ($bat['status_flag'] == 4)  {  if ($bat['blood']>0) { return 2; } else { return 1; }  }
		...
		if (($bat['coment'] =='Бой с Исчадием Хаоса') OR ($bat['coment'] =='<b>Бой с Духом Мерлина</b>')  OR ($bat['coment'] =='<b>Бой с Волнами Драконов</b>')  OR ($bat['type'] ==311)  OR ($bat['type'] ==312) )
		{
