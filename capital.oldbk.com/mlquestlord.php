...
<tr>
<td style="font-size:0px;"><img style="display:block;" src="http://i.oldbk.com/i/map/dialog_top.png"></td>
</tr>
<tr>
<td background="http://i.oldbk.com/i/map/dialog_middle.png"><div style="margin: 0 5px;">%TEXT%</div></td>
</tr>
<tr>
<td style="font-size:0px;"><img style="display:block;" src="http://i.oldbk.com/i/map/dialog_bottom_left.png" align="bottom"></td>
</tr>
</table>
DIAG;
...
<tr>
<td style="font-size:0px;"><img style="display:block;" src="http://i.oldbk.com/i/map/dialog_bottom_middle.png" align="bottom"></td>
</tr>
</table>
DIAGMY;
...
function ShowMLDialog($sd) {
	...
	$t = explode("/",$mlquest);
	$ret = '<div class="mlquest" id="mlquest" style="z-index:1051; position: absolute; left: '.($t[0]).'px; top: '.($t[1]).'px;">';
...
$show = 1;
if (isset($_GET['qaction']) && $_GET['qaction'] == "11111") $show = 0;
