...
while($bd = mysql_fetch_array($q)) 
	...
	if (mysql_affected_rows()>0)
		...
		echo date("H:i:s");
		echo " Бой:".$bd['id']." - закончен по таймауту. Техническая ничья по бездействию в течении 1 мин после тайма \n";
		}
	}
////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// турниры одиночки  -СТАРАЯ ВЕРСИЯ -ВЫКЛЮЧЕНА
/*
	//пока одиночные
...
*/
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// турниры отрядов -СТАРАЯ ВЕРСИЯ -ВЫКЛЮЧЕНА
/*
...
*/
// турниры групп - НОВАЯ ВЕРСИЯ
//Выбираем активные турниры
	...
	if (mysql_num_rows($all_ac_tur) > 0 )
		...
		while($AGrow=mysql_fetch_array($all_ac_tur))
			...
			$btext=str_replace(':','^',$bots_names_chat)." вмешались в поединок!";
...
echo mysql_affected_rows();
	...
	$fp = fopen ("/w/www/ltime.txt","w"); //открытие
