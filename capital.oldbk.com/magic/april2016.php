...
if ($rowm['duration']+1 == $rowm['maxdur']) {
	mysql_query('UPDATE inventory SET maxdur = 1, duration = 0, magic = 0, type = 77, prototype = 2016402 WHERE id ='.$rowm['id'].' LIMIT 1') or die();
} else {
	$bet = 1;
	$sbet = 1;
...
echo 'Вы пошарили в мешке с котом и достали «'.mk_my_item($user,$i['prototype'],$i['shop_id'],$rowm).'»!<br>';
?>