...
$begin1=mktime(0,0,1,01,14,date("Y")); // поправить дату
	...
	if($begin1 < time()) {
		if ($user['battle']>0) { 
			...
			$godendo = mktime(23,59,59,2,13,date("Y"));
	       		...
	       		$gifts=array(
			'5 лет ОлдБК!'=>	array('name'=>'5 лет ОлдБК!',			'maxdur'=>'1',	'cost'=>'5','owner'=>$user[id],'img'=>'5Y_card.gif',		'type'=>'200',	'magic'=>0, 	'massa'=>0.1,	'isrep'=>0,'prototype'=>15276,	'otdel'=>72,	'add_time'=>time(),	'goden'=>'',		'dategoden'=>'','letter'=>'Поздравляем с 5-ой юбилейной годовщиной ОлдБК! Желаем интересной Игры, увлекательных боев, радости общения и много новых и хороших друзей! С праздником! С уважением, Администрация ОлдБК',	'present'=>'Администрации ОлдБК'),
			'Клонирование'=>	array('name'=>'Клонирование',			'maxdur'=>'10',	'cost'=>'5','owner'=>$user[id],'img'=>'mirror.gif',		'type'=>'12',	'magic'=>1616,	'massa'=>1,	'isrep'=>0,'prototype'=>119,  	'otdel'=>51,	'add_time'=>time(),	'goden'=>$last_days,	'dategoden'=>$godendo,	'letter'=>'Поздравляем с 5-ой юбилейной годовщиной ОлдБК! Желаем интересной Игры, увлекательных боев, радости общения и много новых и хороших друзей! С праздником! С уважением, Администрация ОлдБК',	'present'=>'Администрации ОлдБК'),
			...
			'Торт'=>		array('name'=>'Праздничный Торт',		'maxdur'=>'20',	'cost'=>'5','owner'=>$user[id],'img'=>'gift_tort5year.gif',		'type'=>'50',	'magic'=>8,	'massa'=>1,	'isrep'=>0,'prototype'=>105,	'otdel'=>61,	'add_time'=>time(),	'goden'=>$last_days,	'dategoden'=>$godendo,	'letter'=>'Поздравляем с 5-ой юбилейной годовщиной ОлдБК! Желаем интересной Игры, увлекательных боев, радости общения и много новых и хороших друзей! С праздником! С уважением, Администрация ОлдБК',	'present'=>'Администрации ОлдБК'),
			'Гнев Ареса III'=>		array('name'=>'Гнев Ареса III',		'maxdur'=>'10',	'cost'=>'30','owner'=>$user[id],'img'=>'wrath_ares_90_ekr.gif',		'type'=>'12',	'magic'=>155,	'massa'=>0.1,	'isrep'=>0,'prototype'=>150155,	'otdel'=>5,	'add_time'=>time(),	'goden'=>$last_days,	'dategoden'=>$godendo,	'letter'=>'Поздравляем с 5-ой юбилейной годовщиной ОлдБК! Желаем интересной Игры, увлекательных боев, радости общения и много новых и хороших друзей! С праздником! С уважением, Администрация ОлдБК',	'present'=>'Администрации ОлдБК'),
