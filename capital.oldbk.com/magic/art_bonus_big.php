...
$mag_config[120004]=array(
1=> array ('gnoj' =>2) ,
2=> array ('gtopor' => 2) ,
3=> array ('gdubina' => 2), 
4=> array ('gmech' =>2));

$mag_config[120005]=array(
1=> array ('gfire' =>2) ,
2=> array ('gwater' => 2) ,
3=> array ('gair' => 2), 
4=> array ('gearth' =>2) );

$mag_config[120006]=array(
1=> array ('ab_mf' =>3) ,
2=> array ('ab_bron' => 6) ,
...
$conf_array=$conf_array[$pr];
			
			

if ( (($used_blevel>=1) and ($used_blevel<=6)) and (is_array($conf_array)) )
{
//1. проверяем предмет
