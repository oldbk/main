...
$begin1=mktime(0,0,1,01,6,date("Y"));
	...
	if($begin1 < time()) {
		if ($user['battle']>0) { 
			...
			$godendo = mktime(23,59,59,2,13,date("Y"));
	       		...
	       		$gifts=array(
			'4 года ОлдБК!'=>	array('name'=>'4 года ОлдБК!',			'maxdur'=>'1',	'cost'=>'5','owner'=>$user[id],'img'=>'2014gift4years_anim.gif',		'type'=>'200',	'magic'=>0, 	'massa'=>0.1,	'isrep'=>0,'prototype'=>15276,	'otdel'=>72,	'add_time'=>time(),	'goden'=>'',		'dategoden'=>'','letter'=>'Поздравляем с 4 годовщиной ОлдБК! Желаем интересных боев, легких левелов, новых добрых друзей и увлекательной игры! С уважением, Администрация ОлдБК',	'present'=>'Администрации ОлдБК'),
			'Клонирование'=>	array('name'=>'Клонирование',			'maxdur'=>'10',	'cost'=>'5','owner'=>$user[id],'img'=>'mirror.gif',		'type'=>'12',	'magic'=>1616,	'massa'=>1,	'isrep'=>0,'prototype'=>119,  	'otdel'=>51,	'add_time'=>time(),	'goden'=>$last_days,	'dategoden'=>$godendo,	'letter'=>'Поздравляем с 4 годовщиной ОлдБК! Желаем интересных боев, легких левелов, новых добрых друзей и увлекательной игры! С уважением, Администрация ОлдБК',	'present'=>'Администрации ОлдБК'),
			...
			'Торт'=>		array('name'=>'Праздничный Торт',		'maxdur'=>'20',	'cost'=>'5','owner'=>$user[id],'img'=>'tort1b2014.gif',		'type'=>'50',	'magic'=>8,	'massa'=>1,	'isrep'=>0,'prototype'=>105,	'otdel'=>61,	'add_time'=>time(),	'goden'=>$last_days,	'dategoden'=>$godendo,	'letter'=>'Поздравляем с 4 годовщиной ОлдБК! Желаем интересных боев, легких левелов, новых добрых друзей и увлекательной игры! С уважением, Администрация ОлдБК',	'present'=>'Администрации ОлдБК')
			);
