<?php
	...
	$ny_events = array(
		...
		*/		
		...
		'elkacpstart' => $ny_events_cur_m == 12 ? mktime(0,0,0,12,1,$ny_events_cur_y) : mktime(0,0,0,1,1,$ny_events_cur_y),
		'elkacpend' => $ny_events_cur_m == 12 ? mktime(23,59,59,12,31,$ny_events_cur_y) : mktime(23,59,59,2,28,$ny_events_cur_y),
