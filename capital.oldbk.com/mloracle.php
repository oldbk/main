...
<TR>
	...
	<TD align=right>
		<div class="btn-control">
            ...
            <!--INPUT TYPE="button" value="Подсказка" style="background-color:#A9AFC0" onclick="window.open('help/mloracle.html', 'help', 'height=300,width=500,location=no,menubar=no,status=no,toolbar=no,scrollbars=yes')"-->
...
<div id="maindiv" style="position:relative;"><img src="http://i.oldbk.com/i/map/mloracle_bg.jpg" id="mainbg">
<a href="?quest=1"><img style="z-index:3; position: absolute; left: 280px; top: 60px;" src="http://i.oldbk.com/i/map/mloracle_pers1.png" alt="Оракул" title="Оракул" class="aFilter2" onmouseover="this.src='http://i.oldbk.com/i/map/mloracle_pers1_h.png'" onmouseout="this.src='http://i.oldbk.com/i/map/mloracle_pers1.png'"/></a>
</div>
			<?php

			$BotDialog = new \components\Component\Quests\QuestDialogNew(\components\Helper\BotHelper::BOT_ORAKUL);
