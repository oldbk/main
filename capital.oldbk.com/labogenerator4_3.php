...
$mobs=2.3; //% монстров
$lov=1.1;  //% ловушек
$lov_yama=1.4;  //% ловушек простых ям
$lov_yama_fire=1.2;  //% ловушек огненных ям
$lov_yama_ice=1.2;  //% ловушек ледяных ям
$hils=2.1;  //% хилок
$ahils=2.1;  //% хилок
$box=0.8;  //% ящиков пандоры
...
if ($new_floor_map_id>0)
	{
	$mapid=$new_floor_map_id;
	}	
...
/////////////////////////////////// центр
 ...
 $rendu[$dim+1][$dim]='S'; $rendu[$dim+1][$dim+1]='х'; $rendu[$dim+1][$dim+2]='5'; //стрьевщик справа
...
$rendu[$dim+4][$dim+4]='O'; 
//"крыльцо"
$rendu[$dim+5][$dim]='O'; $rendu[$dim+5][$dim+1]='N'; $rendu[$dim+5][$dim+2]='O'; 
