...
if (kurs>1)
	...
	document.getElementById('qrub').value=($co);
	  ...
	  if ($t=='410021')
	  	{
			document.getElementById('410021').style.display='block';
			document.getElementById('410022').style.display='none';			
			document.getElementById('410023').style.display='none';						
	  	}
	  	else if ($t=='410022')
	  	{
			document.getElementById('410021').style.display='none';
			document.getElementById('410022').style.display='block';			
			document.getElementById('410023').style.display='none';						
	  	}
	  	else
	  	{
			document.getElementById('410021').style.display='none';
			document.getElementById('410022').style.display='none';			
			document.getElementById('410023').style.display='block';
	  	}
