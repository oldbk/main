...
var snowStorm = (function(window, document) {
  ...
  this.targetElement = 'ione';    // element which snow will be appended to (null = document.body) - can be an element ID eg. 'myDiv', or a DOM node reference
  ...
  this.resizeHandlerAlt = function() {
    ...
    screenX2 = parseInt(screenX/2,10);
  //  alert(screenX + ' ' +screenY+ ' '+screenX2);
  };         //934 227 467
