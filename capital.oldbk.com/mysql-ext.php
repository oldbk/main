...
$__profiler = '/www/capitalcity.oldbk.com/shared/profiler/';
$__profilermin = 0.8;
...
if (!extension_loaded('mysql') && !function_exists('mysql_connect')) {
	 ...
	 * @return mysqli|null
	 */
	function getLinkIdentifier($mysqli = null)
	{
		if (!$mysqli) {
			global $linkmysqli;
			$mysqli = $linkmysqli;
	...
	function mysql_connect($server, $username, $password, $new_link = false, $client_flags = 0)
	{
		...
		$linkmysqli = mysqli_connect($server, $username, $password);
		return $linkmysqli;
	}
	...
	function mysql_pconnect($server, $username, $password, $new_link = false, $client_flags = 0)
	{
		...
		$linkmysqli = mysqli_connect('p:' . $server, $username, $password);
		return $linkmysqli;
	}
	...
	function mysql_select_db($databaseName)
	{
		...
		return mysqli_select_db($linkmysqli, $databaseName);
	}
	 ...
	 */
	function mysql_query($query, $mysqli = null)
	{
		global $__profiler,$__profilermin;
		if (isset($__profiler) && is_string($__profiler) && is_dir($__profiler)) {
			$time_start = microtime(true);
			$ret = getLinkIdentifier($mysqli)->query($query);
			$timediff = microtime(true) - $time_start;

			if ($__profilermin <= $timediff) {
				$fname = $__profiler.$_SERVER['PHP_SELF'].'-'.($_SESSION['uid'] != null ? $_SESSION['uid'] : "0").'.txt';
				file_put_contents($fname,date("d/m/Y H:i:s")." ".$time_start." ".$timediff.": ".$query."\r\n",LOCK_EX | FILE_APPEND);
			}
	 ...
	 * @return string
	 */
	function mysql_real_escape_string($string,$mysqli = null)
	{
		return getLinkIdentifier($mysqli)->escape_string($string);
	}

	function mysql_escape_string($string, $mysqli = null)
	{
		return getLinkIdentifier($mysqli)->escape_string($string);
	}
	 ...
	 * @return int
	 */
	function mysql_affected_rows($mysqli = null)
	{
	 ...
	 * @return void
	 */
	function mysql_client_encoding($mysqli = null)
	{
	 ...
	 * @return bool
	 */
	function mysql_close($mysqli = null)
	{
	 ...
	 * @return int
	 */
	function mysql_errno($mysqli = null)
	{
	 ...
	 * @return string
	 */
	function mysql_error($mysqli = null)
	{
	 ...
	 * @return bool
	 */
	function mysql_ping($mysqli = null)
	{
	 ...
	 * @param mysqli $mysqli
	 */
	function mysql_unbuffered_query($query, $mysqli = null)
	{
	 ...
	 * @return bool|mysqli_result
	 */
	function mysql_list_dbs($mysqli = null)
	{
	 ...
	 * @return bool|mysqli_result
	 */
	function mysql_list_fields($database_name, $table_name, $mysqli = null)
	{
	 ...
	 * @return bool|mysqli_result
	 */
	function mysql_list_processes($mysqli = null)
	{
	 ...
	 * @return bool
	 */
	function mysql_set_charset($charset, $mysqli = null)
	{
	 ...
	 * @return bool|string
	 */
	function mysql_info($mysqli = null)
	{
	 ...
	 * @return bool|string
	 */
	function mysql_stat($mysqli = null)
	{
	 ...
	 * @return bool|string
	 */
	function mysql_thread_id($mysqli = null)
	{
	 ...
	 * @return bool|string
	 */
	function mysql_get_host_info($mysqli = null)
	{
	 ...
	 * @return bool|string
	 */
	function mysql_get_proto_info($mysqli = null)
	{
	 ...
	 * @return bool|string
	 */
	function mysql_get_server_info($mysqli = null)
	{
	 ...
	 * @return int|string
	 */
	function mysql_insert_id($mysqli = null)
	{
