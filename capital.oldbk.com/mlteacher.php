...
<TR>
	...
	<TD align=right>
        <div class="btn-control">
            ...
            <!--INPUT TYPE="button" value="Подсказка" style="background-color:#A9AFC0" onclick="window.open('help/mlteacher.html', 'help', 'height=300,width=500,location=no,menubar=no,status=no,toolbar=no,scrollbars=yes')"-->
...
<div id="maindiv" style="position:relative;"><img src="http://i.oldbk.com/i/map/mlteacher_bg.jpg" id="mainbg">
<a href="?quest=1"><img style="z-index:3; position: absolute; left: 150px; top: 35px;" src="http://i.oldbk.com/i/map/mlteacher_pers1.png" alt="Наставник" title="Наставник" class="aFilter2" onmouseover="this.src='http://i.oldbk.com/i/map/mlteacher_pers1_h.png'" onmouseout="this.src='http://i.oldbk.com/i/map/mlteacher_pers1.png'"/></a>
</div>
<?php
