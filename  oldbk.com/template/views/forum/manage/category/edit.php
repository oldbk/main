...
<div class="row text-center">
    <div class="col">
        <h4>Редактирование конференции</h4>
    </div>
</div>
    ...
    <div class="col">
        ...
        <form action="<?= $app->urlFor('manage_category_edit', ['id' => $selected_category->id]) ?>" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="topic" class="form-control" id="inputText" placeholder="Название" value="<?= $selected_category->topic ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="text" class="form-control" id="inputDesc" placeholder="Описание" value="<?= $selected_category->text ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" name="fix" class="form-control" id="inputFix" placeholder="Позиция" value="<?= $selected_category->fix ?>">
                </div>
            </div>
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" name="only_own" value="1" type="checkbox" <?= $selected_category->only_own ? 'checked' : '' ?>> разрешается видеть только свои топы
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" name="only_tester" value="1" type="checkbox" <?= $selected_category->is_test ? 'checked' : '' ?>> разрешается видеть только топы для тестеров
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group row">
                <div class="col-sm-2">Скрыть</div>
                <div class="col-sm-10">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input class="form-check-input" name="is_closed" value="1" type="checkbox" <?= $selected_category->is_closed ? 'checked' : '' ?>> скрыть конфу
                        </label>
                    </div>
                </div>
            </div>
